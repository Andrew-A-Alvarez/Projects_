...
/**************************************************** 
Program Name: Week 1 - Labe.java 
Programmer's Name: Andrew Alvarez
Program Description: This program will tell you whether your BMI is normal, underweight, overweight, or obese based off of age, weight, and height
***********************************************************/
public class HealthProfile {
    ...
    public double calculateBMI() {
        double bmi = ( weight * 703 ) / ( Math.pow(weight, 2) );
        return bmi;
    }
